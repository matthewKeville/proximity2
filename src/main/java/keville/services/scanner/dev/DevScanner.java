package keville.services.scanner.dev;
...
import keville.services.scanner.EventScanner;
import keville.services.scanner.ScanReport;
...
public class DevScanner implements EventScanner {
  ...
  public ScanReport scan(Region region) {
    ...
    for ( int i = 0; i < eventCount; i++ ) { 
      ...
      event.organizer = "dev";
      event.url = "localhost";
      event.virtual = random.nextBoolean();
